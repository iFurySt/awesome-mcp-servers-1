...
- [Open Browser Use](https://github.com/iFurySt/open-codex-browser-use) - Open-source browser automation MCP server and skill that connects local AI agents to a real Chrome profile through an MV3 extension, native host, CLI, MCP server, and JS/Python/Go SDKs.
